...
// @desc:    Auth route
// @access:  Private
        //the auth below is the addition of your middleware
router.get('/', auth, async (req, res)=>{
    try {
        //get user info from database using user id
        // -password means you're selecting everything besides the password
